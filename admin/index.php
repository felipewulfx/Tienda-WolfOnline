...
if(!isset($_SESSION['id'])){
  ...
  <head>
    <!-- RESPONSIVE -->
    <link rel="icon" type="favicon" href="admin/avatars/lobo.png">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>Wolf</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>WOLF</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
        <span class="sr-only">Activar Barra de Navegacion</span>
      </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="avatars/lobo.png" style="width:35px;height:35px;" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=admin_name_connected()?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="avatars/lobo.png"  class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="avatars/lobo.png" style="width:35px;height:35px;" class="img-circle" alt="User Image">
        </div>
...
<!--         <li>
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box-body">
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">Crear 5 Nuevos Diseños</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Crear Inventario</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Comprar Prendas para Sublimar</span>
                  <small class="label label-warning"><i class="fa fa-clock-o"></i> 4 Dias</small>
                  <div class="tools">
                    <i class="fa fa-edit"></i>
                    <i class="fa fa-trash-o"></i>
                  </div>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Comprar Prendas Para Estampar</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Comprar Materiales Para Sublimacion y Estampación</span>
                  <small class="label label-primary"><i class="fa fa-clock-o"></i> 5 Dias</small>
                  <div class="tools">
                    <i class="fa fa-edit"></i>
                    <i class="fa fa-trash-o"></i>
                  </div>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Crear Producto Final</span>
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Contáctanos</h3>
              <!-- tools box -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2022 <a href="http://almsaeedstudio.com">Wolf Online</a>.</strong> Todos los Derechos Reservados.
  </footer>
